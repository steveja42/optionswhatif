        ...
        <div className="stockform">
          <form onSubmit={this.handleSubmit} className="form-inline">
            ...
            <div className="form-group">
              ...
              <select name="dates" multiple className="form-control" style={{ width: '12ch', minWidth: '12ch', paddingLeft: '2px', paddingRight: '2px' }} onChange={this.datesChanged} value={datesSelected}>
